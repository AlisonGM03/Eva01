# EVA React + Vite Web Interface

A React + Vite web interface for EVA that allows voice and video interaction.
...
You can modify these settings in `src/config.js` if your EVA backend is running on a different address.
